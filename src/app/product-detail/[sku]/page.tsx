	...
	return (
		<>
			...
			<form className={classes.productDetail}>
				<FormInput property="name" label="Name" type="text" value={name} onUpdate={handleProductChange}/>
				<FormInput property="type" label="Type" type="text" value={type} onUpdate={handleProductChange}/>
				<FormInput property="description" label="Description" type="text" value={description} onUpdate={handleProductChange}/>
				<FormInput property="color" label="Color" type="text" value={color} onUpdate={handleProductChange}/>
				<FormInput property="price" label="Price" type="number" value={price} onUpdate={handleProductChange}/>
